...
2. Cd to 'src', run the following scripts.
    ...
    **Example command is in the file 'demo.sh'.**
    ...
    python3 main.py --model CSNLN --data_test Set5+Set14+B100+Urban100 --data_range 801-900 --scale 4 --n_feats 128 --depth 12 --pre_train ../models/model_x4.pt --save_results --test_only --chop
#python3 main.py --model CSNLN --data_test Thermal --data_range 801-900 --scale 4 --n_feats 128 --depth 12 --pre_train ../models/model_x4.pt --save_results --test_only --chop
    python3 main.py --model CSNLN --data_test Thermal_PNG --data_range 801-900 --scale 4 --n_feats 128 --depth 12 --pre_train ../models/model_x4.pt --save_results --test_only --chop
 python3 main.py --model CSNLN --data_test TestDataset --data_range 801-900 --scale 4 --n_feats 128 --depth 12 --pre_train ../models/model_x4.pt --save_results --test_only --chop
